...
export default function Header() {
  ...
  // Use fast-lc.png as the logo
  const logoSrc = "/fast-lc.png"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="hidden md:inline-block px-6 py-2 rounded-lg bg-[#7A7FEE] text-white font-semibold transition-colors hover:bg-[#6366f1] dark:bg-[#7A7FEE] dark:hover:bg-[#6366f1]"
              >
                Schedule a Demo
              </a>
